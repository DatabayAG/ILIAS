...
!function () {
    "use strict";
    var e = tinymce.util.Tools.resolve("tinymce.PluginManager"), o = function (o) {
    ...
    e.add("code", function (e) {
        ...
        return (t = e).addCommand("mceCodeEditor", function () {
            ...
            icon: "sourcecode", tooltip: "Source code", onAction: function () {
                return o(n)
            }
        }), n.ui.registry.addMenuItem("code", {
            icon: "sourcecode", text: "Source code", onAction: function () {
                return o(n)
            }
        }), {}
    })
